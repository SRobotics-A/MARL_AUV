...
class MARLRiverFlyFollowEnvCfg(DirectMARLEnvCfg):
    ...
    success_velocity_tolerance = 1.5                   # 进入 success zone 的严格速度门槛（enter 条件）
    success_distance_xy_hold: float = 7.0              # 进入后维持 timer 的宽松距离门槛（hold 条件，比 enter 多 1m）
    success_velocity_tolerance_hold: float = 2.0       # 进入后维持 timer 的宽松速度门槛（hold 条件，比 enter 多 0.5 m/s）
